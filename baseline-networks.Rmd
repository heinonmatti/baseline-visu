...
qgraph::flow(BCT_mgm, "MVPA", theme = "colorblind", vsize = 8)
```
...
# save(BCTbootPA, file = "BCTbootPA.Rdata")

load("BCTbootPA.Rdata")
...
A dressed-up version of the last graph. Pies indicate mean as a proportion of the maximum value in tha variable in question. 
...
piefill <- data %>% mutate_all(funs(mean(., na.rm = TRUE) / max(., na.rm = TRUE)))
piefill <- piefill[1, ]
...
# save(bootnet_stability_determinants, file = "bootnet_stability_determinants.Rdata")
load("bootnet_stability_determinants.Rdata")
...
# save(bootnet_centrality_stability_determinants, file = "bootnet_centrality_stability_determinants.Rdata")
load("bootnet_centrality_stability_determinants.Rdata")
