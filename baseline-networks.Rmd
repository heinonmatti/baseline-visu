...
### GGM centrality {.tabset}

#### Description 

This section explores centrality measures for the gaussian models, assumptions of which are arguably less than optimally fulfilled in this data. For caveats to interpreting centrality, see:
...
```{r centrality-diagnostics-manuscript-network}
...
<!-- #### Centrality stability -- Omitted due to technical problems -->

```{r centrality-stability-manuscript, eval = FALSE, include = FALSE}
boot_for_centrality <- bootnet::bootnet(BCT_ggm, nBoots = 2500, type = "case")
```
