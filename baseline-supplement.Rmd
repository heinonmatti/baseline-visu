...
Code chunk below loads needed packages.
...
#**MUUTA VAR NÄISTÄ KAIKISTA, ja tyttöihin ja interventioihin numeroiden sijaan sanat**
...
outtable <- df %>%
  ...
  summarise("Mean daily MVPA minutes (sd)" = paste0(round(mean(paAccelerometer_T1, na.rm = T), 1)," (", 
            ...
            "Mean daily breaks in sitting (sd)" = paste0(round(mean(sitBreaks_T1, na.rm = T), 1)," (", 
                                        round(sd(sitBreaks_T1, na.rm = T), 1), ")"),
            "Mean fat-% (sd)" = paste0(round(mean(fatpct_T1, na.rm = T), 1)," (", 
