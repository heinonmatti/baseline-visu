...
corrgram::corrgram(data.frame("Self-rep PA" = df$padaysLastweek_T1, 
                              "Accelerometer PA" = df$paAccelerometer_T1, 
                              "Sedentary time" = df$sitLieAccelerometer_T1, 
                              "Interrupted sitting" = df$sitBreaks_T1), 
...
MVPAgirl_df <- df %>% group_by(girl) %>% dplyr::select(girl, paAccelerometer_T1) %>% summarise(`mean accelerometer-measured MVPA difference between girls and boys` = mean(paAccelerometer_T1, na.rm = TRUE), `median accelerometer-measured MVPA difference between girls and boys` = median(paAccelerometer_T1, na.rm = TRUE)) 
...
sitBreaks_trackgirl_diamonds_girl %>% DT::datatable() #papaja::apa_table()
sitBreaks_trackgirl_diamonds_boy %>% DT::datatable() #papaja::apa_table()
sitBreaks_trackintervention_diamonds_intervention %>% DT::datatable() #papaja::apa_table()
sitBreaks_trackintervention_diamonds_control %>% DT::datatable() #papaja::apa_table()
