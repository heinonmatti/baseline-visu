...
vardatatable2$Variable <- gsub("mvpaAccelerometer", "Daily MVPA time (accelerometer)", vardatatable2$Variable)
...
vardatatable2 <- vardatatable2 %>% 
  dplyr::filter(Variable == "Daily MVPA time (accelerometer)" | 
  ...
  dplyr::mutate(orderVariable = ifelse(`Variable` == "Daily MVPA time (accelerometer)", "a",
                                ifelse(`Variable` == "Daily time spent sitting or lying down (accelerometer)", "b",
                                ifelse(`Variable` == "Daily number of times sitting was interrupted (accelerometer)", "c",
                                ifelse(`Variable` == "Number of days with >30 MVPA min previous week (self-report)", "d", NA))))) %>% 
...
middle_x_percentile <- function(middle_percentile) {
  df %>%
  dplyr::filter((df$mvpaAccelerometer_T1 > quantile(df$mvpaAccelerometer_T1, probs = c(0.5 - middle_percentile/2, 0.5 + middle_percentile/2), na.rm = TRUE)[[1]]) &
