...
df %>% ggplot2::ggplot(aes(x = group, y = PA_autonomous_T1_centred)) +
...
grid::grid.newpage()
grid::grid.draw(cbind(ggplot2::ggplotGrob(bctInt), ggplot2::ggplotGrob(bctCont), ggplot2::ggplotGrob(bctGirls), ggplot2::ggplotGrob(bctBoys), size = "last"))

# This draws 2 histograms per row:
# grid.newpage()
# grid.draw(rbind(cbind(ggplot2::ggplotGrob(bctInt), ggplot2::ggplotGrob(bctCont), size = "last"), cbind(ggplot2::ggplotGrob(bctGirls), ggplot2::ggplotGrob(bctBoys), size = "last")))
...
# KESKEN. Miten ja kannattaako koitaa tehdä lmer:llä kaikki CI:t vertailun vuoksi?

Try out if we can estimate the intercepts by gender and educational tracks:
...
PA_trackgirl_ci <- data.frame(PA_trackgirl_CIL, PA_trackgirl_estimates, PA_trackgirl_CIH, Variable = labels(brms::ranef(m_paAccelerometer_trackgirl))) %>% 
  ...
  dplyr::mutate(PA_trackgirl_CIL = PA_trackgirl_CIL + b_intercept,
         ...
         track = c('business administration_boy',
                   'business administration_girl',
                   'hospitality_boy',
                   'hospitality_girl',
                   'information technology_boy',
                   'information technology_girl',
                   'nursing_boy',
                   'nursing_girl',
                   'Other_boy',
                   'Other_girl'
...
PA_trackgirl_ci %>% filter(track == "hospitality_girl"),
PA_trackgirl_ci %>% filter(track == "business administration_girl"),
PA_trackgirl_ci %>% filter(track == "information technology_girl")) %>% 
...
PA_trackgirl_ci %>% filter(track == "hospitality_boy"),
PA_trackgirl_ci %>% filter(track == "business administration_boy"),
PA_trackgirl_ci %>% filter(track == "information technology_boy")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come
...
PA_trackintervention_ci <- data.frame(PA_trackintervention_CIL, PA_trackintervention_estimates, PA_trackintervention_CIH, Variable = labels(brms::ranef(m_paAccelerometer_trackintervention))) %>% 
  ...
  dplyr::mutate(PA_trackintervention_CIL = PA_trackintervention_CIL + b_intercept,
         ...
         track = c('business administration_control',
                   'business administration_intervention',
                   'hospitality_control',
                   'hospitality_intervention',
                   'information technology_control',
                   'information technology_intervention',
                   'nursing_control',
...
PA_trackintervention_ci %>% filter(track == "nursing_intervention"),
PA_trackintervention_ci %>% filter(track == "hospitality_intervention"),
PA_trackintervention_ci %>% filter(track == "business administration_intervention"),
PA_trackintervention_ci %>% filter(track == "information technology_intervention")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come

PA_trackintervention_diamonds_control <- rbind(
PA_trackintervention_ci %>% filter(track == "nursing_control"),
PA_trackintervention_ci %>% filter(track == "hospitality_control"),
PA_trackintervention_ci %>% filter(track == "business administration_control"),
PA_trackintervention_ci %>% filter(track == "information technology_control")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come
...
plot1 <- df %>% dplyr::select(id,
  ...
  dplyr::mutate(track = factor(track, levels = c("information technology", "business administration", "hospitality", "nursing")),
                track = recode_factor(track, "information technology" = "IT", "business administration" = "admin", 
                                      "hospitality" = "hospitality", "nursing" = "nursing")) %>% 
  ...
  ggridges::scale_fill_cyclical(
                                labels = c('admin boy' = "Boy", 'admin girl' = "Girl"),
                                values = viridis::viridis(4, end = 0.8)[c(1, 3)],
                                name = "", 
...
plot2 <- df %>% dplyr::select(id,
  ...
  scale_x_continuous(expand = c(0.01, 0)) +
  ggridges::scale_fill_cyclical(
                                labels = c('admin 0' = "Control", 'admin 1' = "Intervention"),
                                values = viridis::viridis(4, end = 0.8)[c(2, 4)],
                                name = "", 
                                guide = guide_legend(override.aes = list(alpha = 1, 
                                                                         point_shape = c(21, 23),
...
## Self-reported MVPA days, previous week {.tabset}
...
padaysLastweek_trackgirl_ci %>% filter(track == "nursing_girl"),
padaysLastweek_trackgirl_ci %>% filter(track == "hospitality_girl"),
padaysLastweek_trackgirl_ci %>% filter(track == "business administration_girl"),
padaysLastweek_trackgirl_ci %>% filter(track == "information technology_girl")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come

padaysLastweek_trackgirl_diamonds_boy <- rbind(
padaysLastweek_trackgirl_ci %>% filter(track == "nursing_boy"),
padaysLastweek_trackgirl_ci %>% filter(track == "hospitality_boy"),
padaysLastweek_trackgirl_ci %>% filter(track == "business administration_boy"),
padaysLastweek_trackgirl_ci %>% filter(track == "information technology_boy")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come
...
padaysLastweek_trackintervention_ci %>% filter(track == "nursing_intervention"),
padaysLastweek_trackintervention_ci %>% filter(track == "hospitality_intervention"),
padaysLastweek_trackintervention_ci %>% filter(track == "business administration_intervention"),
padaysLastweek_trackintervention_ci %>% filter(track == "information technology_intervention")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come

padaysLastweek_trackintervention_diamonds_control <- rbind(
padaysLastweek_trackintervention_ci %>% filter(track == "nursing_control"),
padaysLastweek_trackintervention_ci %>% filter(track == "hospitality_control"),
padaysLastweek_trackintervention_ci %>% filter(track == "business administration_control"),
padaysLastweek_trackintervention_ci %>% filter(track == "information technology_control")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come

padaysLastweek_trackgirl_diamonds_girl
padaysLastweek_trackgirl_diamonds_boy
padaysLastweek_trackintervention_diamonds_intervention
padaysLastweek_trackintervention_diamonds_control
```
...
plotboys <- df %>% dplyr::select(id,
                                 ...
                                 girl,
                                 padaysLastweek_T1)  %>%
  filter(!is.na(track), track != "Other", girl == "boy") %>% # Drop category "Other"
  dplyr::mutate(track = factor(track, levels = c("information technology", "business administration", "hospitality", "nursing")),
                track = recode_factor(track, "information technology" = "IT", "business administration" = "admin", 
                                      "hospitality" = "hospitality", "nursing" = "nursing")) %>% 
  ggplot2::ggplot(aes(y = track)) +
...
plotgirls <- df %>% dplyr::select(id,
                                 ...
                                 girl,
                                 padaysLastweek_T1)  %>%
  filter(!is.na(track), track != "Other", girl == "girl") %>% # Drop category "Other"
  dplyr::mutate(track = factor(track, levels = c("information technology", "business administration", "hospitality", "nursing")),
                track = recode_factor(track, "information technology" = "IT", "business administration" = "admin", 
                                      "hospitality" = "hospitality", "nursing" = "nursing")) %>% 
  ggplot2::ggplot(aes(y = track)) +
...
plotcontrol <- df %>% dplyr::select(id,
                                 ...
                                 intervention,
                                 padaysLastweek_T1)  %>%
  filter(!is.na(track), track != "Other", intervention == "0") %>% # Drop category "Other"
  dplyr::mutate(track = factor(track, levels = c("information technology", "business administration", "hospitality", "nursing")),
                track = recode_factor(track, "information technology" = "IT", "business administration" = "admin", 
                                      "hospitality" = "hospitality", "nursing" = "nursing")) %>% 
  ggplot2::ggplot(aes(y = track)) +
...
plotintervention <- df %>% dplyr::select(id,
                                 ...
                                 intervention,
                                 padaysLastweek_T1)  %>%
  filter(!is.na(track), track != "Other", intervention == "1") %>% # Drop category "Other"
  dplyr::mutate(track = factor(track, levels = c("information technology", "business administration", "hospitality", "nursing")),
                track = recode_factor(track, "information technology" = "IT", "business administration" = "admin", 
                                      "hospitality" = "hospitality", "nursing" = "nursing")) %>% 
  ggplot2::ggplot(aes(y = track)) +
...
## Number of average interruptions to sitting {.tabset}
...
sitBreaks_trackgirl_ci %>% filter(track == "nursing_girl"),
sitBreaks_trackgirl_ci %>% filter(track == "hospitality_girl"),
sitBreaks_trackgirl_ci %>% filter(track == "business administration_girl"),
sitBreaks_trackgirl_ci %>% filter(track == "information technology_girl")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come

sitBreaks_trackgirl_diamonds_boy <- rbind(
sitBreaks_trackgirl_ci %>% filter(track == "nursing_boy"),
sitBreaks_trackgirl_ci %>% filter(track == "hospitality_boy"),
sitBreaks_trackgirl_ci %>% filter(track == "business administration_boy"),
sitBreaks_trackgirl_ci %>% filter(track == "information technology_boy")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come
...
sitBreaks_trackintervention_ci %>% filter(track == "nursing_intervention"),
sitBreaks_trackintervention_ci %>% filter(track == "hospitality_intervention"),
sitBreaks_trackintervention_ci %>% filter(track == "business administration_intervention"),
sitBreaks_trackintervention_ci %>% filter(track == "information technology_intervention")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come

sitBreaks_trackintervention_diamonds_control <- rbind(
sitBreaks_trackintervention_ci %>% filter(track == "nursing_control"),
sitBreaks_trackintervention_ci %>% filter(track == "hospitality_control"),
sitBreaks_trackintervention_ci %>% filter(track == "business administration_control"),
sitBreaks_trackintervention_ci %>% filter(track == "information technology_control")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come

sitBreaks_trackgirl_diamonds_girl
sitBreaks_trackgirl_diamonds_boy
sitBreaks_trackintervention_diamonds_intervention
sitBreaks_trackintervention_diamonds_control
```
...
### Prepare data: sitting & lying down
...
sitLie_trackgirl_ci %>% filter(track == "nursing_girl"),
sitLie_trackgirl_ci %>% filter(track == "hospitality_girl"),
sitLie_trackgirl_ci %>% filter(track == "business administration_girl"),
sitLie_trackgirl_ci %>% filter(track == "information technology_girl")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come

sitLie_trackgirl_diamonds_boy <- rbind(
sitLie_trackgirl_ci %>% filter(track == "nursing_boy"),
sitLie_trackgirl_ci %>% filter(track == "hospitality_boy"),
sitLie_trackgirl_ci %>% filter(track == "business administration_boy"),
sitLie_trackgirl_ci %>% filter(track == "information technology_boy")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come
...
sitLie_trackintervention_ci %>% filter(track == "nursing_intervention"),
sitLie_trackintervention_ci %>% filter(track == "hospitality_intervention"),
sitLie_trackintervention_ci %>% filter(track == "business administration_intervention"),
sitLie_trackintervention_ci %>% filter(track == "information technology_intervention")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come

sitLie_trackintervention_diamonds_control <- rbind(
sitLie_trackintervention_ci %>% filter(track == "nursing_control"),
sitLie_trackintervention_ci %>% filter(track == "hospitality_control"),
sitLie_trackintervention_ci %>% filter(track == "business administration_control"),
sitLie_trackintervention_ci %>% filter(track == "information technology_control")) %>% 
  arrange(-row_number()) # reverse order of rows to make them right for the plot to come

sitLie_trackgirl_diamonds_girl
sitLie_trackgirl_diamonds_boy
sitLie_trackintervention_diamonds_intervention
sitLie_trackintervention_diamonds_control
...
plot1 <- df %>% dplyr::select(id,
                              ...
                              girl,
                              PA = paAccelerometer_T1)  %>%
  filter(!is.na(trackSchool), !grepl('Other|NANA|business administration4|hospitality2|nursing2', trackSchool)) %>% # Drop categories with just few participants
  ...
  scale_x_continuous(expand = c(0.01, 0)) +
  ggridges::scale_fill_cyclical(
                                labels = c('business administration1 boy' = "Boy", 'business administration1 girl' = "Girl"),
                                values = viridis::viridis(4, end = 0.8)[c(1, 3)],
                                name = "", guide = guide_legend(override.aes = list(alpha = 1))) +
  ggridges::scale_colour_cyclical(values = "black") +
  ggridges::theme_ridges(grid = FALSE) +
...
symphospitality <- df %>% dplyr::select(id,
  intervention,
  track,
  school,
  girl,
...
sympIT <- df %>% dplyr::select(id,
  ...
  "Tiredness or faintness" = symptom_tirednessFaintness_T1) %>%
 tidyr::gather(key = Variable, value = Value, 6:ncol(.)) %>%
  filter(track == "information technology") %>% 
 ggplot2::ggplot(aes(x = Value, y = Variable, group = Variable)) +
  ggridges::geom_density_ridges2(aes(fill = Variable), stat = "binline", binwidth = 1, scale = 0.95) +
  scale_x_continuous(breaks = c(1:4), expand = c(0, 0),
                     name = "") +
  scale_y_discrete(expand = c(0.01, 0), name = "") +
  ggridges::scale_fill_cyclical(values = c("deepskyblue", "deepskyblue4")) +
  labs(title = "information technology") +
  guides(y = "none") +
  ggridges::theme_ridges(grid = FALSE) +
  theme(axis.title.x = element_text(hjust = 0.5),
        axis.title.y = element_text(hjust = 0.5),
...
sympBA <- df %>% dplyr::select(id,
  ...
  "Tiredness or faintness" = symptom_tirednessFaintness_T1) %>%
 tidyr::gather(key = Variable, value = Value, 6:ncol(.)) %>%
  filter(track == "business administration") %>% 
 ggplot2::ggplot(aes(x = Value, y = Variable, group = Variable)) +
  ggridges::geom_density_ridges2(aes(fill = Variable), stat = "binline", binwidth = 1, scale = 0.95) +
  scale_x_continuous(breaks = c(1:4), expand = c(0, 0),
                     name = "") +
  scale_y_discrete(expand = c(0.01, 0), name = "", labels = NULL) +
  ggridges::scale_fill_cyclical(values = c("deepskyblue", "deepskyblue4")) +
  labs(title = "business administration") +
  guides(y = "none") +
  ggridges::theme_ridges(grid = FALSE) +
  theme(axis.title.x = element_text(hjust = 0.5),
        axis.title.y = element_text(hjust = 0.5),
...
#grid.arrange(sympIT, symphospitality, sympBA, sympnursing, ncol = 2)

# ("Seldom or never", "About once a month", "About once a week", "Almost daily")

# This draws all histograms next to each other:
grid::grid.newpage()
grid::grid.draw(cbind(ggplot2::ggplotGrob(sympIT), ggplot2::ggplotGrob(sympBA), ggplot2::ggplotGrob(symphospitality), ggplot2::ggplotGrob(sympnursing), size = "last"))

# This draws 2 histograms per row:
#grid.newpage()
#grid.draw(rbind(cbind(ggplot2::ggplotGrob(sympIT), ggplot2::ggplotGrob(sympBA), size = "last"), cbind(ggplot2::ggplotGrob(symphospitality), ggplot2::ggplotGrob(sympnursing), size = "last")))
