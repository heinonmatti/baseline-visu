...
# Compare different estimates for means and CIs visually 
...
```{r lm-for-comparison-nordpaq_dysfunctional_itemAccelerometer, eval = FALSE}
...
exerciseTypes_girlboy_proportions %>% t() %>% 
  DT::datatable() #papaja::apa_table()
