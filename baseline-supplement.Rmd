...
vardatatable %>% select(Variable, `ICC class`, `ICC school`, n) %>% arrange(desc(`ICC class`)) %>% top_n(20) %>% apa_table(caption = "Intra-class correlations sorted by classroom ICC")

```

```{r}

vardatatable %>% select(Variable, `ICC class`, `ICC school`, n) %>% arrange(desc(`ICC school`)) %>% top_n(20) %>% apa_table(caption = "Intra-class correlations sorted by school ICC")
