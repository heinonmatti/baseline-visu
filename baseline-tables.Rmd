...
```{r}
# df %>% group_by(girl) %>% summarise(mean = mean(mvpaAccelerometer_T1, na.rm = TRUE))
# data.frame(ci_table_boys, ci_boys$diamondlabels)
# data.frame(ci_table_girls, ci_boys$diamondlabels)
```
