...
```{r table-parameters-bayes, include = FALSE}
...
Based on the information criterion (WAIC), models do not seem to differ with regards their out-of-sample prediction ability.
...
# prior_intercept_fromFeasibility <- brms::prior_summary(m_sitLieAccelerometer_T1, data = dftest)
# prior_intercept_fromFeasibility[1, 1] <- "normal(563.32, 79.34)"
# 
# m_priorFromFeasibility <- brms::brm(
#   sitLieAccelerometer_T1 ~ 1 + (1|school) + (1|group), data=dftest,
...
brms::prior_summary(m_sitLieAccelerometer_T1, data = dftest)
brms::prior_summary(m_priorFromFeasibility, data = dftest)
brms::prior_summary(m_sitLieWithTrack, data = dftest)
